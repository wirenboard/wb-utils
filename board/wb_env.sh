...
#    WB_GPIO_NRF_EN=37;
    ...
    export WB_PWM_BUZZER WB_ADC_TYPE WB_GSM_POWER_TYPE WB_GPIO_GSM_POWER WB_GPIO_GSM_PWRKEY WB_GPIO_GSM_STATUS;
    ;;
    ...
    export WB_PWM_BUZZER WB_ADC_TYPE \
        WB_GSM_POWER_TYPE WB_GSM_HAS_STATUS_PIN WB_GPIO_RFM_IRQ WB_RFM_SPI_MINOR WB_RFM_SPI_MAJOR WB_GPIO_GSM_POWER WB_GPIO_GSM_PWRKEY \
        WB_GPIO_GSM_STATUS WB_GPIO_5V_ON WB_GPIO_VOUT_ON WB_GPIO_VOUT_ST WB_GSM_STATUS_PIN_INVERTED WB_GPIO_GSM_SIMSELECT;
